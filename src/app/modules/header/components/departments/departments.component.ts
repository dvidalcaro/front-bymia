...
import {Navigation, NavigationLink} from '../../../../shared/interfaces/navigation-link';
...
export class DepartmentsComponent implements OnInit, OnDestroy, AfterViewInit, AfterViewChecked {
    ...
    ngOnInit(): void {
        ...
        this.shop.getCategories(null, 1).pipe(
            ...
            map(items => items.map((item: Category) => new Navigation(item.name, '/shop/catalog', item.children)))
